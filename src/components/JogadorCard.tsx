...
export default function JogadorCard({ jogador, selecionado, onToggle, podeSelecionar }: Props) {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="sticker-header" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <span style={{
          background: pos.bg, color: pos.text,
      ...
      {/* Foto */}
      <div className="sticker-img" style={{ height: '110px', position: 'relative', overflow: 'hidden', background: '#c8dff0' }}>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src={`/players/${jogador.id}-${slug}.png`}
          alt={jogador.nome}
        ...
        <div style={{
          ...
          background: 'rgba(0,39,118,0.85)', color: '#FFDF00',
      ...
      {/* Nome */}
      <div style={{ background: 'linear-gradient(135deg, #002776 0%, #001a55 100%)', padding: '4px 6px', textAlign: 'center' }}>
        <div style={{
          color: '#fff', fontFamily: 'Bebas Neue, sans-serif',
          fontSize: '13px', letterSpacing: '0.5px', lineHeight: 1.1,
          whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis',
        }}>
          {jogador.nome}
        </div>
        <div style={{
          color: '#FFDF00', fontSize: '9px', fontFamily: 'Barlow, sans-serif',
      ...
      <div className="sticker-footer" style={{ display: 'flex', justifyContent: 'space-around', padding: '4px 6px' }}>
        <div style={{ textAlign: 'center' }}>
          <div style={{ color: '#FFDF00', fontFamily: 'Bebas Neue, sans-serif', fontSize: '13px', lineHeight: 1 }}>{jogador.caps}</div>
          <div style={{ color: 'rgba(255,255,255,0.7)', fontSize: '8px', fontFamily: 'Barlow, sans-serif' }}>JOGOS</div>
        </div>
        <div style={{ width: '1px', background: 'rgba(255,255,255,0.2)' }} />
        <div style={{ textAlign: 'center' }}>
          <div style={{ color: '#FFDF00', fontFamily: 'Bebas Neue, sans-serif', fontSize: '13px', lineHeight: 1 }}>{jogador.gols}</div>
          <div style={{ color: 'rgba(255,255,255,0.7)', fontSize: '8px', fontFamily: 'Barlow, sans-serif' }}>GOLS</div>
        </div>
        <div style={{ width: '1px', background: 'rgba(255,255,255,0.2)' }} />
        <div style={{ textAlign: 'center' }}>
          <div style={{ color: '#FFDF00', fontFamily: 'Bebas Neue, sans-serif', fontSize: '13px', lineHeight: 1 }}>{jogador.idade}</div>
      ...
      <div className="check-overlay">
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ color: '#FFDF00', fontFamily: 'Bebas Neue, sans-serif', fontSize: '11px', marginTop: '2px' }}>CONVOCADO</div>
        </div>
      </div>
    </div>
  );
